...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    name: "Suraj Kiran Panda",
    image: assets.profile_pic,
    email: 'surajkiranpanda98@gmail.com',
    phone: '+91 9861669622',
    address: {
      line1: "Kakatpur, Tulamala",
      line2: "Puri, Odisha, India"
    },
    gender: 'Male',
    dob: '2002-05-06'
  });
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        {
          //if isEdit is true then show input field else show p tag
          isEdit
        ...
        <div className='mt-10'>
          {
            isEdit
            ? <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all' onClick={()=>setIsEdit(false)}>Save Info</button>
