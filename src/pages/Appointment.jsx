  ...
  return docInfo && (
    <div className="p-4 sm:p-8 bg-gray-50">
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6 transition-transform transform hover:scale-105 shadow-lg'>Book an appointment</button>
      </div>
